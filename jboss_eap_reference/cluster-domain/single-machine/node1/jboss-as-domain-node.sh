...
JBOSS_PIDFILE=/var/run/jboss-eap-6.4/jboss-as-domain-node.pid
JBOSS_CONSOLE_LOG=/opt/rh/jboss-eap-6.4/domain/log/console.log
JBOSS_SCRIPT="$JBOSS_HOME/bin/domain.sh -b 10.20.1.40 -bmanagement 10.20.1.40"

# chkconfig: 2345 85 15
# description: jboss-eap-6.4-node1
# processname: jboss-as-domain-node
# pidfile: /var/run/jboss-eap-6.4/jboss-as-domain-node.pid
