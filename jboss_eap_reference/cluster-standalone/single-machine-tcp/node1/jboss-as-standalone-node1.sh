...
JBOSS_SCRIPT="$JBOSS_HOME/bin/standalone.sh -b 10.20.1.31 -bmanagement 0.0.0.0 -Djboss.server.base.dir=$JBOSS_HOME/standalone-node-1 -Djboss.socket.binding.port-offset=100 -Djboss.node.name=standalone-node-1"
