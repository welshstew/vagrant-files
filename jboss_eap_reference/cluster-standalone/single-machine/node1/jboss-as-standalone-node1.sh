...
JBOSS_PIDFILE=/var/run/jboss-eap-6.4/jboss-as-standalone-node-1.pid
JBOSS_CONSOLE_LOG=/opt/rh/jboss-eap-6.4/standalone-node-1/log/console.log
JBOSS_CONFIG=standalone-ha.xml
JBOSS_SCRIPT="$JBOSS_HOME/bin/standalone.sh -b 10.20.1.31 -bmanagement 0.0.0.0 -u 230.0.0.4 -Djboss.server.base.dir=$JBOSS_HOME/standalone-node-1 -Djboss.socket.binding.port-offset=100 -Djboss.node.name=standalone-node-1"

# chkconfig: 2345 85 15
# description: jboss-eap-6.4-node1
# processname: jboss-as-standalone-node1
# pidfile: /var/run/jboss-eap-6.4/jboss-as-standalone-node-1.pid
