...
JBOSS_SCRIPT="$JBOSS_HOME/bin/standalone.sh -b 10.20.1.35 -bmanagement 0.0.0.0 -u 230.0.0.4 -Djboss.server.base.dir=$JBOSS_HOME/standalone-node-1 -Djboss.node.name=standalone-node-1"
