...
JBOSS_SCRIPT="$JBOSS_HOME/bin/standalone.sh -b 10.20.1.35 -bmanagement 10.20.1.35 -Djboss.server.base.dir=$JBOSS_HOME/standalone-node-1 -Djboss.node.name=standalone-node-1"
